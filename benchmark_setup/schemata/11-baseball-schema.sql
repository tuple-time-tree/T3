...
DROP TABLE IF EXISTS baseball."allstarfull";
...
DROP TABLE IF EXISTS baseball."appearances";

CREATE TABLE baseball."appearances" (
                               "yearID" integer ,
                               "teamID" varchar(5) ,
                               "lgID" varchar(2) DEFAULT NULL,
                               "playerID" varchar(11) ,
...
DROP TABLE IF EXISTS baseball."awardsmanagers";
...
DROP TABLE IF EXISTS baseball."awardsplayers";
...
DROP TABLE IF EXISTS baseball."awardssharemanagers";

CREATE TABLE baseball."awardssharemanagers" (
                                       "awardID" varchar(17) ,
                                       "yearID" integer ,
                                       "lgID" varchar(4) ,
                                       "managerID" varchar(12) ,
...
DROP TABLE IF EXISTS baseball."awardsshareplayers";

CREATE TABLE baseball."awardsshareplayers" (
                                      "awardID" varchar(20) ,
                                      "yearID" integer ,
                                      "lgID" varchar(4) ,
                                      "playerID" varchar(11) ,
...
DROP TABLE IF EXISTS baseball."battingpost";

CREATE TABLE baseball."battingpost" (
                               "yearID" integer ,
                               "round" varchar(7) ,
                               "playerID" varchar(11) ,
...
DROP TABLE IF EXISTS baseball."els_teamnames";

CREATE TABLE baseball."els_teamnames" (
                                 "id" integer ,
                                 "lgid" varchar(2) ,
                                 "teamid" varchar(5) ,
...
DROP TABLE IF EXISTS baseball."fieldingof";

CREATE TABLE baseball."fieldingof" (
                              "playerID" varchar(11) ,
                              "yearID" integer ,
                              "stint" integer ,
...
DROP TABLE IF EXISTS baseball."fieldingpost";

CREATE TABLE baseball."fieldingpost" (
                                "playerID" varchar(11) ,
                                "yearID" integer ,
                                "teamID" varchar(3) DEFAULT NULL,
                                "lgID" varchar(2) DEFAULT NULL,
...
DROP TABLE IF EXISTS baseball."halloffame";

CREATE TABLE baseball."halloffame" (
                              "hofID" varchar(12) ,
                              "yearID" integer ,
...
DROP TABLE IF EXISTS baseball."managers";
...
DROP TABLE IF EXISTS baseball."managershalf";

CREATE TABLE baseball."managershalf" (
                                "managerID" varchar(12) ,
                                "yearID" integer ,
                                "teamID" varchar(5) ,
                                "lgID" varchar(2) DEFAULT NULL,
...
DROP TABLE IF EXISTS baseball."pitchingpost";

CREATE TABLE baseball."pitchingpost" (
                                "playerID" varchar(11) ,
                                "yearID" integer ,
                                "round" varchar(7) ,
                                "teamID" varchar(3) DEFAULT NULL,
...
DROP TABLE IF EXISTS baseball."players";
...
DROP TABLE IF EXISTS baseball."salaries";

CREATE TABLE baseball."salaries" (
                            "yearID" integer ,
                            "teamID" varchar(5) ,
                            "lgID" varchar(4) ,
                            "playerID" varchar(11) ,
...
DROP TABLE IF EXISTS baseball."schools";
...
DROP TABLE IF EXISTS baseball."schoolsplayers";

CREATE TABLE baseball."schoolsplayers" (
                                  "playerID" varchar(11) ,
                                  "schoolID" varchar(13) ,
...
DROP TABLE IF EXISTS baseball."seriespost";

CREATE TABLE baseball."seriespost" (
                              "yearID" integer ,
                              "round" varchar(7) ,
...
DROP TABLE IF EXISTS baseball."teams";
...
DROP TABLE IF EXISTS baseball."teamsfranchises";
...
DROP TABLE IF EXISTS baseball."teamshalf";

CREATE TABLE baseball."teamshalf" (
                             "yearID" integer ,
                             "lgID" varchar(4) ,
                             "teamID" varchar(5) ,
                             "Half" varchar(2) ,
