CREATE SCHEMA geneea;
DROP TABLE IF EXISTS geneea."bod_schuze";

CREATE TABLE geneea."bod_schuze" (
                              "id_bod" integer ,
                              "id_schuze" integer ,
...
DROP TABLE IF EXISTS geneea."bod_stav";

CREATE TABLE geneea."bod_stav" (
                            "id_bod_stav" integer ,
                            "popis" varchar(255) DEFAULT NULL,
                            PRIMARY KEY ("id_bod_stav")
) ;

DROP TABLE IF EXISTS geneea."funkce";

CREATE TABLE geneea."funkce" (
                          "id_funkce" integer ,
...
DROP TABLE IF EXISTS geneea."hl_check";

CREATE TABLE geneea."hl_check" (
...
DROP TABLE IF EXISTS geneea."hl_hlasovani";

CREATE TABLE geneea."hl_hlasovani" (
...
DROP TABLE IF EXISTS geneea."hl_poslanec";

CREATE TABLE geneea."hl_poslanec" (
                               "id_poslanec" integer ,
                               "id_hlasovani" integer ,
                               "vysledek" varchar(255) DEFAULT NULL
) ;

DROP TABLE IF EXISTS geneea."hl_vazby";

CREATE TABLE geneea."hl_vazby" (
                            "id_hlasovani" integer DEFAULT NULL,
                            "turn" integer DEFAULT NULL,
                            "typ" integer DEFAULT NULL
) ;

DROP TABLE IF EXISTS geneea."hl_zposlanec";

CREATE TABLE geneea."hl_zposlanec" (
                                "id_hlasovani" integer DEFAULT NULL,
                                "id_osoba" integer DEFAULT NULL,
                                "mode" integer DEFAULT NULL
) ;

DROP TABLE IF EXISTS geneea."omluvy";

CREATE TABLE geneea."omluvy" (
                          "id_organ" integer ,
                          "id_poslanec" integer ,
                          "den" varchar(255) ,
...
DROP TABLE IF EXISTS geneea."organy";

CREATE TABLE geneea."organy" (
                          "id_organ" integer ,
...
DROP TABLE IF EXISTS geneea."osoby";

CREATE TABLE geneea."osoby" (
                         "id_osoba" integer ,
...
DROP TABLE IF EXISTS geneea."pkgps";

CREATE TABLE geneea."pkgps" (
...
DROP TABLE IF EXISTS geneea."poslanec";

CREATE TABLE geneea."poslanec" (
                            "id_poslanec" integer ,
                            "id_osoba" integer DEFAULT NULL,
...
DROP TABLE IF EXISTS geneea."schuze";

CREATE TABLE geneea."schuze" (
                          "id_schuze" integer ,
                          "id_organ" integer DEFAULT NULL,
                          "schuze" integer DEFAULT NULL,
...
DROP TABLE IF EXISTS geneea."schuze_stav";

CREATE TABLE geneea."schuze_stav" (
...
DROP TABLE IF EXISTS geneea."typ_funkce";

CREATE TABLE geneea."typ_funkce" (
...
DROP TABLE IF EXISTS geneea."typ_organu";

CREATE TABLE geneea."typ_organu" (
                              "id_typ_org" integer ,
...
DROP TABLE IF EXISTS geneea."zarazeni";

CREATE TABLE geneea."zarazeni" (
                            "id_osoba" integer DEFAULT NULL,
...
DROP TABLE IF EXISTS geneea."zmatecne";

CREATE TABLE geneea."zmatecne" (
    "id_hlasovani" integer DEFAULT NULL
) ;
