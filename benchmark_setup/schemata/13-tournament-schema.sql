...
DROP TABLE IF EXISTS tournament."regular_season_compact_results";

CREATE TABLE tournament."regular_season_compact_results" (
                                                  "season" integer ,
                                                  "daynum" integer ,
                                                  "wteam" integer ,
...
DROP TABLE IF EXISTS tournament."regular_season_detailed_results";

CREATE TABLE tournament."regular_season_detailed_results" (
                                                   "season" integer ,
                                                   "daynum" integer ,
                                                   "wteam" integer ,
                                                   "wscore" integer ,
...
DROP TABLE IF EXISTS tournament."seasons";

CREATE TABLE tournament."seasons" (
                           "season" integer ,
...
DROP TABLE IF EXISTS tournament."target";

CREATE TABLE tournament."target" (
                          "id" varchar(17) ,
...
DROP TABLE IF EXISTS tournament."teams";
...
DROP TABLE IF EXISTS tournament."tourney_compact_results";

CREATE TABLE tournament."tourney_compact_results" (
                                           "season" integer ,
                                           "daynum" integer ,
                                           "wteam" integer ,
                                           "wscore" integer DEFAULT NULL,
...
DROP TABLE IF EXISTS tournament."tourney_detailed_results";

CREATE TABLE tournament."tourney_detailed_results" (
                                            "season" integer ,
                                            "daynum" integer ,
                                            "wteam" integer ,
                                            "wscore" integer DEFAULT NULL,
...
DROP TABLE IF EXISTS tournament."tourney_seeds";

CREATE TABLE tournament."tourney_seeds" (
                                 "season" integer ,
                                 "seed" varchar(7) ,
...
DROP TABLE IF EXISTS tournament."tourney_slots";

CREATE TABLE tournament."tourney_slots" (
                                 "season" integer ,
                                 "slot" varchar(7) ,
