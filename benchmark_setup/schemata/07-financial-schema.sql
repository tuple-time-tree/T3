...
DROP TABLE IF EXISTS financial."client";
...
DROP TABLE IF EXISTS financial."disp";
...
DROP TABLE IF EXISTS financial."district";
...
DROP TABLE IF EXISTS financial."loan";
...
DROP TABLE IF EXISTS financial."order";

CREATE TABLE financial."order" (
...
DROP TABLE IF EXISTS financial."trans";
