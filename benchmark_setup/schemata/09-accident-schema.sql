...
DROP TABLE IF EXISTS accident."nesreca";

CREATE TABLE accident."nesreca" (
...
DROP TABLE IF EXISTS accident."oseba";

CREATE TABLE accident."oseba" (
                         "id_nesreca" char(6) NOT NULL,
...
DROP TABLE IF EXISTS accident."upravna_enota";

CREATE TABLE accident."upravna_enota" (
