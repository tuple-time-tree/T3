...
DROP TABLE IF EXISTS basketball."awards_coaches";

CREATE TABLE basketball."awards_coaches" (
                                  "id" integer ,
...
DROP TABLE IF EXISTS basketball."awards_players";

CREATE TABLE basketball."awards_players" (
                                  "playerID" varchar(13) ,
                                  "award" varchar(39) ,
                                  "year" integer ,
                                  "lgID" varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS basketball."coaches";

CREATE TABLE basketball."coaches" (
                           "coachID" varchar(14) ,
                           "year" integer ,
                           "tmID" varchar(7) ,
                           "lgID" varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS basketball."draft";

CREATE TABLE basketball."draft" (
...
DROP TABLE IF EXISTS basketball."player_allstar";

CREATE TABLE basketball."player_allstar" (
                                  "playerID" varchar(13) ,
...
DROP TABLE IF EXISTS basketball."players_teams";

CREATE TABLE basketball."players_teams" (
                                 "id" integer ,
                                 "playerID" varchar(13) ,
                                 "year" integer DEFAULT NULL,
...
DROP TABLE IF EXISTS basketball."series_post";

CREATE TABLE basketball."series_post" (
                               "id" integer ,
                               "year" integer DEFAULT NULL,
